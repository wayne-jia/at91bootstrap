...
void nandflash_set_smc_timing(unsigned int mode)
{
	...
	if (mode == TIMING_MODE_5) {
		writel(AT91C_SMC_NWESETUP_(1), AT91C_BASE_SMC + SMC_SETUP2);

		writel(AT91C_SMC_NWEPULSE_(3) | AT91C_SMC_NCS_WRPULSE_(7) |
		       AT91C_SMC_NRDPULSE_(5) | AT91C_SMC_NCS_RDPULSE_(6),
	...
	if (mode == TIMING_MODE_4) {
		...
		writel(AT91C_SMC_NWEPULSE_(4) | AT91C_SMC_NCS_WRPULSE_(9) |
		       AT91C_SMC_NRDPULSE_(5) | AT91C_SMC_NCS_RDPULSE_(7),
		       AT91C_BASE_SMC + SMC_PULSE2);

		writel(AT91C_SMC_NWECYCLE_(9) | AT91C_SMC_NRDCYCLE_(7),
		       AT91C_BASE_SMC + SMC_CYCLE2);
	...
	if (mode == TIMING_MODE_3) {
		...
		writel(AT91C_SMC_NWEPULSE_(4) | AT91C_SMC_NCS_WRPULSE_(10) |
		       AT91C_SMC_NRDPULSE_(5) | AT91C_SMC_NCS_RDPULSE_(8),
		       AT91C_BASE_SMC + SMC_PULSE2);
