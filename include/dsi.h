...
typedef struct
{  /* LCD Controller */
  __I   u8                        Reserved1[0x04];
  __IO  u32                       DSI_PWR_UP;         /**< Offset: 0x04 (R/W  32) Power-Up Control Register */
  __IO  u32                       DSI_CLKMGR_CFG;     /**< Offset: 0x08 (R/W  32) Clock Management Configuration Register */
  __IO  u32                       DSI_DPI_VCID;       /**< Offset: 0x0C (R/W  32) Input Video Virtual Channel ID Configuration Register */
  __IO  u32                       DSI_DPI_COLOR_CODING; /**< Offset: 0x10 (R/W  32) Input Video Color Coding Configuration Register */
  __IO  u32                       DSI_DPI_CFG_POL;    /**< Offset: 0x14 (R/W  32) Input Video Polarity Configuration Register */
  __IO  u32                       DSI_DPI_LP_CMD_TIM; /**< Offset: 0x18 (R/W  32) Input Video Timing for Low-Power Commands Configuration Register */
  __I   u8                        Reserved2[0x10];
  __IO  u32                       DSI_PCKHDL_CFG;     /**< Offset: 0x2C (R/W  32) DSI Protocol Configuration Register */
  __IO  u32                       DSI_GEN_VCID;       /**< Offset: 0x30 (R/W  32) Read Generic Virtual Channel ID Configuration Register */
  __IO  u32                       DSI_MODE_CFG;       /**< Offset: 0x34 (R/W  32) Mode of Operation Configuration Register */
  __IO  u32                       DSI_VID_MODE_CFG;   /**< Offset: 0x38 (R/W  32) Video Mode Configuration Register */
  __IO  u32                       DSI_VID_PKT_SIZE;   /**< Offset: 0x3C (R/W  32) Video Mode packet size Configuration Register */
  __IO  u32                       DSI_VID_NUM_CHUNKS; /**< Offset: 0x40 (R/W  32) Video Mode Number of Chunks Configuration Register */
  __IO  u32                       DSI_VID_NULL_SIZE;  /**< Offset: 0x44 (R/W  32) Video Mode Null Packets Size Configuration Register */
  __IO  u32                       DSI_VID_HSA_TIME;   /**< Offset: 0x48 (R/W  32) Video Mode HSA Time Configuration Register */
  __IO  u32                       DSI_VID_HBP_TIME;   /**< Offset: 0x4C (R/W  32) Video Mode HBP Time Configuration Register */
  __IO  u32                       DSI_VID_HLINE_TIME; /**< Offset: 0x50 (R/W  32) Video Mode HLINE Time Configuration Register */
  __IO  u32                       DSI_VID_VSA_LINES;  /**< Offset: 0x54 (R/W  32) Video Mode VSA Lines Configuration Register */
  __IO  u32                       DSI_VID_VBP_LINES;  /**< Offset: 0x58 (R/W  32) Video Mode VBP Lines Configuration Register */
  __IO  u32                       DSI_VID_VFP_LINES;  /**< Offset: 0x5C (R/W  32) Video Mode VFP Lines Configuration Register */
  __IO  u32                       DSI_VID_VACTIVE_LINES; /**< Offset: 0x60 (R/W  32) Video Mode VACTIVE Lines Configuration Register */
  __I   u8                        Reserved3[0x04];
  __IO  u32                       DSI_CMD_MODE_CFG;   /**< Offset: 0x68 (R/W  32) Command Mode Configuration Register */
  __IO  u32                       DSI_GEN_HDR;        /**< Offset: 0x6C (R/W  32) Generic Interface Header Register */
  __IO  u32                       DSI_GEN_PLD_DATA;   /**< Offset: 0x70 (R/W  32) Generic Interface Payload Register */
  __I   u32                       DSI_CMD_PKT_STATUS; /**< Offset: 0x74 (R/   32) Command Packet Status Register */
  __IO  u32                       DSI_TO_CNT_CFG;     /**< Offset: 0x78 (R/W  32) Timeout Counters Configuration Register */
  __IO  u32                       DSI_HS_RD_TO_CNT;   /**< Offset: 0x7C (R/W  32) HS Read Response Timeout Counter Configuration Register */
  __IO  u32                       DSI_LP_RD_TO_CNT;   /**< Offset: 0x80 (R/W  32) LP Read Response Timeout Counter Configuration Register */
  __IO  u32                       DSI_HS_WR_TO_CNT;   /**< Offset: 0x84 (R/W  32) HS Write Response Timeout Counter Configuration Register */
  __IO  u32                       DSI_LP_WR_TO_CNT;   /**< Offset: 0x88 (R/W  32) LP Write Response Timeout Counter Configuration Register */
  __IO  u32                       DSI_BTA_TO_CNT;     /**< Offset: 0x8C (R/W  32) BTA Response Timeout Counter Configuration Register */
  __IO  u32                       DSI_SDF_3D;         /**< Offset: 0x90 (R/W  32) VSS Packet 3D Control Register */
  __IO  u32                       DSI_LPCLK_CTRL;     /**< Offset: 0x94 (R/W  32) Clock Lane Control Register */
  __IO  u32                       DSI_DPHY_TMR_LPCLK_CFG; /**< Offset: 0x98 (R/W  32) Clock Lane Switch Mode Timing Configuration Register */
  __IO  u32                       DSI_DPHY_TMR_CFG;   /**< Offset: 0x9C (R/W  32) Data Lane Switch Mode Timing Configuration Register */
  __IO  u32                       DSI_DPHY_RSTZ;      /**< Offset: 0xA0 (R/W  32) Reset and PLL Control Register */
  __IO  u32                       DSI_DPHY_IF_CFG;    /**< Offset: 0xA4 (R/W  32) D-PHY Interface Configuration Register */
  __IO  u32                       DSI_DPHY_ULPS_CTRL; /**< Offset: 0xA8 (R/W  32) D-PHY ULPS Control Register */
  __IO  u32                       DSI_DPHY_TX_TRIGGERS; /**< Offset: 0xAC (R/W  32) D-PHY Tx Trigger Control Register */
  __I   u32                       DSI_DPHY_STATUS;    /**< Offset: 0xB0 (R/   32) D-PHY Status Register */
  __IO  u32                       DSI_DPHY_TST_CTRL0; /**< Offset: 0xB4 (R/W  32) D-PHY Control Register 0 */
  __IO  u32                       DSI_DPHY_TST_CTRL1; /**< Offset: 0xB8 (R/W  32) D-PHY Control Register 1 */
  __I   u32                       DSI_INT_ST0;        /**< Offset: 0xBC (R/   32) Interrupt Status Register 0 */
  __I   u32                       DSI_INT_ST1;        /**< Offset: 0xC0 (R/   32) Interrupt Status Register 1 */
  __IO  u32                       DSI_INT_MSK0;       /**< Offset: 0xC4 (R/W  32) Interrupt Mask Configuration Register 0 */
  __IO  u32                       DSI_INT_MSK1;       /**< Offset: 0xC8 (R/W  32) Interrupt Mask Configuration Register 1 */
  __IO  u32                       DSI_DPHY_CAL;       /**< Offset: 0xCC (R/W  32) D-PHY Calibration Control Register */
  __I   u8                        Reserved4[0x08];
  __IO  u32                       DSI_INT_FORCE0;     /**< Offset: 0xD8 (R/W  32) Interrupt Force Control Register 0 */
  __IO  u32                       DSI_INT_FORCE1;     /**< Offset: 0xDC (R/W  32) Interrupt Force Control Register 1 */
  __IO  u32                       DSI_AUTO_ULPS_MODE; /**< Offset: 0xE0 (R/W  32) Automatic Ultra-Low-Power Mode Register */
  __IO  u32                       DSI_AUTO_ULPS_ENTRY_DELAY; /**< Offset: 0xE4 (R/W  32) Automatic Ultra-Low-Power Entry Delay Register */
  __IO  u32                       DSI_AUTO_ULPS_WAKEUP_TIME; /**< Offset: 0xE8 (R/W  32) Automatic Ultra-Low-Power Wake-Up Time Register */
  __I   u8                        Reserved5[0x08];
  __IO  u32                       DSI_DPHY_TMR_RD_CFG; /**< Offset: 0xF4 (R/W  32) DHY Read Timing Configuration Register */
  __IO  u32                       DSI_AUTO_ULPS_MIN_TIME; /**< Offset: 0xF8 (R/W  32) Automatic Ultra-Low-Power Minimum Time Register */
  __I   u8                        Reserved6[0x04];
  __IO  u32                       DSI_VID_SHADOW_CTRL; /**< Offset: 0x100 (R/W  32) Video Mode Shadow Feature Control Register */
  __I   u8                        Reserved7[0x08];
  __I   u32                       DSI_DPI_VCID_ACT;   /**< Offset: 0x10C (R/   32) Input Video Virtual Channel ID Active Value Register */
  __I   u32                       DSI_DPI_COLOR_CODING_ACT; /**< Offset: 0x110 (R/   32) Input Video Color Coding Active Value Register */
  __I   u8                        Reserved8[0x04];
  __I   u32                       DSI_DPI_LP_CMD_TIM_ACT; /**< Offset: 0x118 (R/   32) Input Video Timing for Low-Power Commands Active Value Register */
  __I   u8                        Reserved9[0x1C];
  __I   u32                       DSI_VID_MODE_CFG_ACT; /**< Offset: 0x138 (R/   32) Video Mode Active Value Register */
  __I   u32                       DSI_VID_PKT_SIZE_ACT; /**< Offset: 0x13C (R/   32) Video Mode packet size Active Value Register */
  __I   u32                       DSI_VID_NUM_CHUNKS_ACT; /**< Offset: 0x140 (R/   32) Video Mode Number of Chunks Active Value Register */
  __I   u32                       DSI_VID_NULL_SIZE_ACT; /**< Offset: 0x144 (R/   32) Video Mode Null Packets Size Active Value Register */
  __I   u32                       DSI_VID_HSA_TIME_ACT; /**< Offset: 0x148 (R/   32) Video Mode HSA Time Active Value Register */
  __I   u32                       DSI_VID_HBP_TIME_ACT; /**< Offset: 0x14C (R/   32) Video Mode HBP Time Active Value Register */
  __I   u32                       DSI_VID_HLINE_TIME_ACT; /**< Offset: 0x150 (R/   32) Video Mode HLINE Time Active Value Register */
  __I   u32                       DSI_VID_VSA_LINES_ACT; /**< Offset: 0x154 (R/   32) Video Mode VSA Lines Active Value Register */
  __I   u32                       DSI_VID_VBP_LINES_ACT; /**< Offset: 0x158 (R/   32) Video Mode VBP Lines Active Value Register */
  __I   u32                       DSI_VID_VFP_LINES_ACT; /**< Offset: 0x15C (R/   32) Video Mode VFP Lines Active Value Register */
  __I   u32                       DSI_VID_VACTIVE_LINES_ACT; /**< Offset: 0x160 (R/   32) Video Mode VACTIVE Lines Active Value Register */
  __I   u8                        Reserved10[0x04];
  __I   u32                       DSI_VID_PKT_STATUS; /**< Offset: 0x168 (R/   32) Video Mode Packet Status Register */
  __I   u8                        Reserved11[0x24];
  __I   u32                       DSI_SDF_3D_ACT;     /**< Offset: 0x190 (R/   32) VSS Packet 3D Active Value Register */
} dsi_registers_t;
